...
def callback_t_1(arg1 ,arg2 , arg3):
    p1.set('%02:%02:%02'%(int(h_p_1.get()),int(m_p_1.get()),int(s_p_1.get())))

def callback_t_2(arg1 ,arg2 , arg3):
    p2.set('%02:%02:%02'%(int(h_p_2.get()),int(m_p_2.get()),int(s_p_2.get())))

def callback_t_3(arg1 ,arg2 , arg3):
    p3.set('%02:%02:%02'%(int(h_p_3.get()),int(m_p_3.get()),int(s_p_3.get())))
